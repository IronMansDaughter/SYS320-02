...
# Storyline: This bash script performs local security checks
...
# Check the password max amount of time(days) between password changes
...
# Check legacy entries exist in /etc/passwd
...
# Check legacy entries exist in /etc/shadow
...
# Check legacy entries exist in /etc/group
...
# Check that root is the only UID 0 account .. . . . .lol I'm tired
...
# Check if the IP forwarding is disabled
