...
$myDir = "C:\Users\Janelle Fisher\Desktop\"
...
$searchKey = Read-Host -Prompt "Please input a keyword or phrase you would like to search for in the logs"

# Print the log to the screen
Get-EventLog -LogName $readLog | Where-Object {$_.Message -ilike "*$searchKey*" } | Export-Csv -NoTypeInformation `
