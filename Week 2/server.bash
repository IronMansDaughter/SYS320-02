...
# Check if the WireGuard server configuration file exists
if [[ -f "$config_file" ]]; then
    read -p "WireGuard configuration file already exists. Do you want to overwrite it? (yes/no): " overwrite
